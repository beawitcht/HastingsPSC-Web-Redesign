function updateBlockFields(blockDiv) {
    ...
    // const addInlineToggle = blockDiv.querySelector(".inline-link-toggle");
    // const inlineToggleLabel = blockDiv.querySelector(".inline-toggle-label");
    // const linkTextLabel = blockDiv.querySelector(".inline-link-label");
    // const linkTextInput = blockDiv.querySelector(".block-inline-link-text");
    // const linkUrlLabel = blockDiv.querySelector(".inline-url-label");
    // const linkUrlInput = blockDiv.querySelector(".block-inline-link-url");
    ...
    if (val === "image") {
        ...
        // // inline link
        // setVisibility(linkTextLabel, false);
        // setVisibility(linkTextInput, false);
        // setVisibility(linkUrlLabel, false);
        // setVisibility(linkUrlInput, false);
        // setVisibility(addInlineToggle, false);
        // setVisibility(inlineToggleLabel, false);
        ...
        // // inline link
        // setVisibility(linkTextLabel, true);
        // setVisibility(linkTextInput, true);
        // setVisibility(linkUrlLabel, true);
        // setVisibility(linkUrlInput, true);
        // setVisibility(addInlineToggle, true);
        // setVisibility(inlineToggleLabel, true);
